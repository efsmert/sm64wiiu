...
static void gfx_glx_set_keyboard_callbacks(kb_callback_t on_key_down, kb_callback_t on_key_up, void (*on_all_keys_up)(void),
...
static void gfx_glx_set_scroll_callback(UNUSED void (*on_scroll)(float, float)) {
}
...
static void gfx_glx_start_text_input(void) {
}

static void gfx_glx_stop_text_input(void) {
}

static char *gfx_glx_get_clipboard_text(void) {
    static char clipboard_text[WAPI_CLIPBOARD_BUFSIZ] = { 0 };
    return clipboard_text;
}

static void gfx_glx_set_clipboard_text(UNUSED const char *text) {
}

static void gfx_glx_set_cursor_visible(UNUSED bool visible) {
}

static void gfx_glx_delay(unsigned int ms) {
    struct timespec ts = { ms / 1000, (ms % 1000) * 1000000L };
    nanosleep(&ts, NULL);
}

static int gfx_glx_get_max_msaa(void) {
    return 0;
}

static void gfx_glx_set_window_title(UNUSED const char *title) {
}

static void gfx_glx_reset_window_title(void) {
}

static bool gfx_glx_has_focus(void) {
    return true;
}
...
struct GfxWindowManagerAPI gfx_glx = {
    ...
    gfx_glx_get_time,
    gfx_glx_shutdown,
    gfx_glx_start_text_input,
    gfx_glx_stop_text_input,
    gfx_glx_get_clipboard_text,
    gfx_glx_set_clipboard_text,
    gfx_glx_set_cursor_visible,
    gfx_glx_delay,
    gfx_glx_get_max_msaa,
    gfx_glx_set_window_title,
    gfx_glx_reset_window_title,
    gfx_glx_has_focus
};
