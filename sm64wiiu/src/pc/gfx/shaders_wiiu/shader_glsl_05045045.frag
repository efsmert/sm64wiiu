...
uniform vec2 window_params;

#define used_textures_0 true
#define used_textures_1 false
#define fog_used false
#define alpha_used true
#define noise_used false
#define texture_edge true
#define color_alpha_same true
...
#define do_single_0 false
#define do_single_1 false
#define do_multiply_0 true
#define do_multiply_1 true
#define do_mix_0 true
#define do_mix_1 true
...
void main() {
    ...
    if (alpha_used && noise_used) {
        texel.a *= floor(random(vec3(floor(gl_FragCoord.xy * (240.0 / window_params[0])), window_params[1])) + 0.5);
    }
