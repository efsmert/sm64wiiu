...
static void gfx_dxgi_set_keyboard_callbacks(kb_callback_t on_key_down, kb_callback_t on_key_up, void (*on_all_keys_up)(void),
...
static void gfx_dxgi_shutdown(void) {
}

static void gfx_dxgi_start_text_input(void) {
}

static void gfx_dxgi_stop_text_input(void) {
}
...
static void gfx_dxgi_delay(unsigned int ms) {
    Sleep(ms);
}
