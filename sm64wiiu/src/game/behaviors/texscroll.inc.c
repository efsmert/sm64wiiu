/*
 * Ported from Co-op DX texscroll behavior support.
 * Credit: https://github.com/jesusyoshi54 (RM2C / scrolling textures support).
 */
...
/*
 * Scroll parameters are read from the object's properties:
 *   Xpos = speed
