...
#ifndef TARGET_N64
                    smlua_call_event_hooks_allow_interact(m, object, interactType, &allowInteract);
#endif
                    if (!allowInteract) {
                        continue;
                    }
...
#ifndef TARGET_N64
                        smlua_call_event_hooks_interact(m, object, interactType, true);
#endif
                        break;
                    }
#ifndef TARGET_N64
                    smlua_call_event_hooks_interact(m, object, interactType, false);
#endif
                }
            }
        }
...
#ifndef TARGET_N64
    smlua_call_event_hooks_mario(HOOK_ON_INTERACTIONS, m);
#endif
