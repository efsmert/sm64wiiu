...
// 0x98 unused/removed in vanilla; Co-op DX uses this slot for object sync metadata.
...
// 0x1A4 is unused in vanilla; Co-op DX uses this slot for network sync flags.
