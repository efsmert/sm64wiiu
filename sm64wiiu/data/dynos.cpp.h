...
// Co-op DX uses OPTIMIZE_O3 to apply per-function optimization attributes in
// a few hot helpers. The Wii U port build does not define it globally; keep it
// as a no-op so the DynOS headers compile cleanly as C++.
#ifndef OPTIMIZE_O3
#define OPTIMIZE_O3
#endif
...
void DynOS_Model_InitPools(void);
