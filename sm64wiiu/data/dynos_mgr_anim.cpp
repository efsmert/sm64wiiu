...
#ifdef TARGET_WII_U
// Wii U build: DynOS animation swapping depends on CoopDX-specific animation tables and Mario animation
// structures that are not yet fully ported. Keep DynOS level/geo/gfx support buildable by stubbing.
