...
#ifdef TARGET_WII_U
// Wii U decomp keeps most texture arrays `static` in their translation units,
// so Co-op DX's built-in texture symbol table cannot link here.
// DynOS mods should ship their own textures on Wii U.
