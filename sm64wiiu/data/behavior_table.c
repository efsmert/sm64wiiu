...
// Declare them as weak so the table can still link (missing scripts resolve to NULL).
extern const BehaviorScript bhvBlueCoinNumber[] __attribute__((weak));
extern const BehaviorScript bhvBooBossSpawnedBridge[] __attribute__((weak));
extern const BehaviorScript bhvBubblePlayer[] __attribute__((weak));
extern const BehaviorScript bhvSquarishPathParent[] __attribute__((weak));
extern const BehaviorScript bhvStarNumber[] __attribute__((weak));
extern const BehaviorScript RM_Scroll_Texture[] __attribute__((weak));
extern const BehaviorScript editor_Scroll_Texture[] __attribute__((weak));
extern const BehaviorScript bhvAmbientLight[] __attribute__((weak));
extern const BehaviorScript bhvPointLight[] __attribute__((weak));
